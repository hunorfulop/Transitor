...
namespace Transitor
{
    public partial class Checking : System.Web.UI.Page
    {
        ...
        string getId()
        {
            ...
            sqlCmd.Parameters.AddWithValue("@ProjectName", Session["checkprojectname"].ToString());
        ...
        {
            if (Session["checkprojectname"].ToString() == "expired")
            {
        ...
        protected void btnCorrect_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (TextAreaTranslatedPhrase.InnerHtml == "")
                {
                    lblErrorMessage.Visible = true;
                    lblErrorMessage.Text = "Please correct the phrase!";
                }
                else
                {
                    string projectID4;
        ...
        protected void btnFinishTrans_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["checkprojectname"] = "expired";
